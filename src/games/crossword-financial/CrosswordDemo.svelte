<script lang="ts">
	...
	const financialWords = [
		...
		{ word: 'АКЦИЯ', hint: 'Ценная бумага компании', definition: 'ценная бумага, дающая право на долю в собственности компании и получение части прибыли в виде дивидендов.' },
		...
		{ word: 'ВАЛЮТА', hint: 'Денежная единица страны', definition: 'денежная единица государства, используемая в международных расчетах. Может быть национальной или иностранной.' },
		{ word: 'ДОЛЛАР', hint: 'Американская валюта', definition: 'денежная единица США и ряда других стран. Одна из основных резервных валют мира.' },
		{ word: 'ПЛАТЕЖ', hint: 'Перевод денежных средств', definition: 'процесс передачи денежных средств от плательщика получателю. Может быть наличным или безналичным.' },
		{ word: 'ПРОЦЕНТ', hint: 'Плата за использование денег', definition: 'доход от предоставления денег в долг или размещения на депозите. Выражается в процентах годовых.' },
		{ word: 'КАПИТАЛ', hint: 'Накопленные средства для инвестиций', definition: 'накопленные денежные средства или имущество, используемые для получения прибыли через инвестиции.' },
		{ word: 'ДЕПОЗИТ', hint: 'Денежные средства на хранении', definition: 'денежные средства, переданные банку на хранение на определенных условиях с выплатой процентов.' },
		{ word: 'ПРИБЫЛЬ', hint: 'Разница между доходом и расходами', definition: 'финансовый результат деятельности, превышение доходов над расходами. Основная цель бизнеса.' },
		{ word: 'ДИВИДЕНД', hint: 'Выплата акционерам компании', definition: 'часть прибыли компании, распределяемая между акционерами пропорционально количеству принадлежащих им акций.' },
		{ word: 'ИНВЕСТОР', hint: 'Тот, кто вкладывает капитал', definition: 'физическое или юридическое лицо, вкладывающее денежные средства в активы с целью получения прибыли.' }
	];
...
<style>
	...
	.word-row.submitted .letter-cell:nth-child(6) { animation-delay: 500ms; }
	.word-row.submitted .letter-cell:nth-child(7) { animation-delay: 600ms; }
	.word-row.submitted .letter-cell:nth-child(8) { animation-delay: 700ms; }
