...
export const tasks: Task[] = [
	...
	{
		id: 'task-11',
		title: 'Изучите ипотечные программы',
		description: 'Узнайте о семейной ипотеке и программах для IT-специалистов',
		fullDescription: 'Познакомьтесь с разными видами ипотеки: семейная ипотека под 6%, ипотека для IT-специалистов, дальневосточная ипотека. Сравните условия и выберите подходящую.',
		reward: 1800,
		difficulty: 'easy',
		status: 'available',
		category: 'mortgage',
		estimatedTime: '5 мин',
		productUrl: 'https://www.gazprombank.ru/personal/mortgage/',
		productName: 'Ипотечные программы',
		icon: '🏠',
		requirements: ['Изучить виды ипотеки', 'Сравнить ставки', 'Узнать о господдержке'],
		gradient: 'linear-gradient(135deg, rgba(209, 60, 106, 0.70) 0%, rgba(226, 165, 58, 0.60) 50%, rgba(0, 122, 195, 0.50) 100%)',
		themeColor: 'var(--color-state-danger)'
	},
	{
		id: 'task-12',
		title: 'Рассчитайте автокредит',
		description: 'Используйте калькулятор для расчета кредита на автомобиль',
		fullDescription: 'Рассчитайте ежемесячный платеж по автокредиту. Изучите условия кредита на новые и подержанные автомобили, узнайте о господдержке.',
		reward: 1500,
		difficulty: 'easy',
		status: 'available',
		category: 'auto',
		estimatedTime: '4 мин',
		productUrl: 'https://www.gazprombank.ru/personal/avtokredit/',
		productName: 'Автокредит',
		icon: '🚗',
		requirements: ['Выбрать тип автомобиля', 'Рассчитать платеж', 'Изучить условия'],
		gradient: 'linear-gradient(140deg, rgba(0, 106, 165, 0.75) 0%, rgba(43, 180, 138, 0.65) 50%, rgba(113, 229, 241, 0.55) 100%)',
		themeColor: 'var(--color-brand-500)'
	},
	{
		id: 'task-13',
		title: 'Кредит наличными под залог',
		description: 'Изучите возможности получения крупного кредита под залог недвижимости',
		fullDescription: 'Узнайте о кредите наличными под залог недвижимости: низкие ставки, крупные суммы, длительные сроки. Изучите требования и процесс оформления.',
		reward: 2200,
		difficulty: 'medium',
		status: 'available',
		category: 'credit',
		estimatedTime: '8 мин',
		productUrl: 'https://www.gazprombank.ru/personal/bail/pod-zalog/',
		productName: 'Кредит под залог недвижимости',
		icon: '🏘️',
		requirements: ['Изучить условия залога', 'Узнать максимальную сумму', 'Ознакомиться с документами'],
		gradient: 'linear-gradient(150deg, rgba(11, 15, 33, 0.80) 0%, rgba(0, 59, 92, 0.70) 50%, rgba(0, 106, 165, 0.60) 100%)',
		themeColor: 'var(--color-brand-600)'
	},
	{
		id: 'task-14',
		title: 'Карта для автолюбителей',
		description: 'Оформите карту Газпромбанк-Газпромнефть с повышенным кэшбэком на заправках',
		fullDescription: 'Получайте до 10% кэшбэка на заправках Газпромнефть! Изучите условия карты: 3% кэшбэк в ресторанах, 1% на все остальные покупки. Бесплатное обслуживание при расходах от 10 000₽ в месяц.',
		reward: 1600,
		difficulty: 'easy',
		status: 'available',
		category: 'cards',
		estimatedTime: '6 мин',
		productUrl: 'https://www.gazprombank.ru/personal/cards/5275845/',
		productName: 'Карта Газпромбанк-Газпромнефть',
		icon: '⛽',
		requirements: ['Изучить кэшбэк программу', 'Узнать об условиях обслуживания', 'Оформить заявку'],
		gradient: 'linear-gradient(125deg, rgba(227, 30, 36, 0.75) 0%, rgba(0, 106, 165, 0.65) 50%, rgba(43, 180, 138, 0.55) 100%)',
		themeColor: '#E31E24'
	},
	{
		id: 'task-15',
		title: 'Поддержите ФК Зенит!',
		description: 'Оформите карту любимой команды с эксклюзивными преимуществами',
		fullDescription: 'Станьте частью команды! Дебетовая карта Газпромбанк-ФК Зенит: до 6% кэшбэк в выбранных категориях, специальные предложения от клуба, бесплатное обслуживание.',
		reward: 1700,
		difficulty: 'easy',
		status: 'available',
		category: 'cards',
		estimatedTime: '5 мин',
		productUrl: 'https://www.gazprombank.ru/personal/cards/42389/',
		productName: 'Карта Газпромбанк-ФК Зенит',
		icon: '⚽',
		requirements: ['Узнать о привилегиях', 'Выбрать категории кэшбэка', 'Заказать карту'],
		gradient: 'linear-gradient(135deg, rgba(0, 102, 204, 0.80) 0%, rgba(31, 196, 217, 0.70) 50%, rgba(113, 229, 241, 0.60) 100%)',
		themeColor: '#0066CC'
	},
	{
		id: 'task-16',
		title: 'Газпромбанк Мобайл',
		description: 'Подключите мобильную связь со скидкой до 30%',
		fullDescription: 'Умная карта + выгодная мобильная связь! Получите скидку до 30% на тарифы, до 7% кэшбэк на все покупки. Два продукта в одном предложении.',
		reward: 1400,
		difficulty: 'easy',
		status: 'available',
		category: 'cards',
		estimatedTime: '4 мин',
		productUrl: 'https://www.gazprombank.ru/personal/cards/6942197/',
		productName: 'Газпромбанк Мобайл',
		icon: '📱',
		requirements: ['Изучить тарифы', 'Рассчитать скидку', 'Оформить комбо-предложение'],
		gradient: 'linear-gradient(130deg, rgba(0, 163, 224, 0.75) 0%, rgba(64, 214, 230, 0.65) 50%, rgba(113, 229, 241, 0.55) 100%)',
		themeColor: '#00A3E0'
	},
	{
		id: 'task-17',
		title: 'Рефинансирование кредитов',
		description: 'Снизьте ставку по существующим кредитам',
		fullDescription: 'Объедините несколько кредитов в один с более выгодной ставкой. Изучите условия рефинансирования, рассчитайте экономию, оформите заявку онлайн.',
		reward: 2800,
		difficulty: 'medium',
		status: 'available',
		category: 'credit',
		estimatedTime: '12 мин',
		productUrl: 'https://www.gazprombank.ru/personal/take_credit/consumer_credit/42164/',
		productName: 'Рефинансирование кредитов',
		icon: '🔄',
		requirements: ['Рассчитать новую ставку', 'Узнать о выгоде', 'Подать заявку'],
		gradient: 'linear-gradient(145deg, rgba(0, 59, 92, 0.85) 0%, rgba(38, 147, 212, 0.75) 50%, rgba(31, 196, 217, 0.65) 100%)',
		themeColor: 'var(--color-brand-700)'
	}
];
...
export const taskCategories: TaskCategory[] = [
	...
	},
	{
		...
		tasks: tasks.filter(task => task.category === 'mortgage')
	},
	{
		id: 'auto',
		name: 'Автокредит',
		icon: '🚗',
		color: 'gradient-mint',
		tasks: tasks.filter(task => task.category === 'auto')
	}
];
