...
<main class="bank-home">
	<section class="hero surface-contrast">
		...
		<p class="hero-subtitle text-balance">
			Это демонстрационная страница главного экрана мобильного приложения Газпромбанка для показа пути пользователя и перехода в Игровой Центр через stories.
		</p>
	</section>
