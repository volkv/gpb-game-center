...
<img src="static/logo_black.svg" width="300" alt="Газпром.Тех">
...
Разработано для хакатона **Газпром.Тех** — Задача №5: Геймификация в мобильном приложении банка

---

## 📄 Лицензия

Проект разработан в рамках хакатона Газпром.Тех 2025
